...
const PROCESO_MAP: Record<string, string> = {
  ...
  // ENVOLVER (proceso independiente)
  'ENVOLVER': 'ENVOLVER',
  'ENVOLTURA': 'ENVOLVER',
  // EMPACAR
  'EMPACAR': 'EMPACAR',
  ...
  // CODIFICAR
  'CODIFICAR': 'CODIFICAR',
  'CODIFICADO': 'CODIFICAR',
  'CODIFICACION': 'CODIFICAR',
  'CODIFICACIÓN': 'CODIFICAR',
  // ACONDICIONAR (ACONDICIONADO/TERMO = proceso combinado)
  ...
  // TERMOENCOGIDO (proceso independiente)
  'TERMOENCOGIDO': 'TERMOENCOGIDO',
  'TERMOENCOGIBLE': 'TERMOENCOGIDO',
  'TERMOENCOGIDO/TERMO': 'TERMOENCOGIDO',
  // ENSAMBLAR
  'ENSAMBLAR': 'ENSAMBLAR',
  'ENSAMBLE': 'ENSAMBLAR',
