...
export default function RRHHInformeRangoPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6 flex-wrap">
        <button onClick={() => router.push('/rrhh/horas-extra')} className="text-gray-500 hover:text-white">
          <ArrowLeft size={18} />
        </button>
        <h1 className="text-xl font-bold text-white flex items-center gap-2">
          <FileBarChart2 size={20} className="text-yellow-400" />
      ...
      <div className="flex flex-wrap items-end gap-3 mb-6 p-4 rounded-xl" style={{ background: '#111827', border: '1px solid #1e293b' }}>
        ...
        <button onClick={cargar} disabled={loading}
          ...
          style={{ background: 'linear-gradient(135deg, #92400e, #b45309)', border: '1px solid #fbbf24' }}>
